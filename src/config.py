...
NUM_IMAGES = 400        # Na ilu zdjęciach pracujemy (im więcej, tym mądrzejsze AI)
NOISE_LEVEL = 30         # Siła szumu (0-255)
BLUR_KERNEL = 11         # Siła rozmycia (musi być nieparzysta)
SCALE_FACTOR = 2         # Siła pikselozy

# --- PARAMETRY TRENINGU AI ---
IMG_SIZE = 256           # Wielkość wycinka (crop) do nauki
BATCH_SIZE = 16           # Ile wycinków naraz (zmniejsz do 4 jak braknie pamięci)
EPOCHS = 50              # Czas nauki (60 epok przy 100 zdjęciach wystarczy na start)
